	...
	if($_SESSION['traveler']){
		...
		if (isset($_POST['Input'])){
			...
			$tmp = $_FILES['logo']['name'];
			$path = "../assets/images/".$logo;
			if 			
			$connect->query("INSERT INTO rute (logo,waktu, tanggal, maskapai, asal, tujuan, harga) VALUES ('$logo',$waktu','$tanggal','$maskapai','$asal','$tujuan','$harga')");
		}
		?>
							...
							<div class="box-body">
								<form role="form" method="POST">
									...
									<div class="form-group"> 
										...
										<input type="text" class="form-control" id="maskapai" placeholder="Maskapai" name="maskapai"> 
									</div> 
									<div class="form-group"> 
